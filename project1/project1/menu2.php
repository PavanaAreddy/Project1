...
<div id="product-grid" style="margin-left:100px;">
	...
	<?php
	$product_array = $db_handle->runQuery("SELECT `pid`,`name`,`price`,`image` FROM `products`");
	if (!empty($product_array)) { 
		...
		<div class="product-item">
			...
			<div class="product-tile-footer">
                        ...
                        <div class="cart-action"><input type="number" class="product-quantity" min="1" name="quantity" value="1" size="2" height="10" width="20" /><input type="image" src="addbtn.jpg" class="cart-item-image"style="width:50; height:50;" /></div>
			</div>
			</form>
		</div>
	<?php
